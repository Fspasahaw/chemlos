...
return [
    ...
    | try and automatically detect it for you. To learn more, please visit
    ...
    */
    ...
    'testing' => [
        ...
        'ensure_pages_exist' => (bool) env('INERTIA_TESTING_ENSURE_PAGES_EXIST', true),
    ...
    */
    ...
    | browser's history state, preventing sensitive information from being
    | accessible after logout. Can also be enabled per-request or via the
    | `inertia.encrypt` middleware.
    |
    */
