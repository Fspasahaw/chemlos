...
class KerusakanController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = KerusakanAlat::with('alat:id,nama,kode', 'peminjaman:id,kode')
        ...
        return Inertia::render('Dashboard/Mahasiswa/Kerusakan/Index', [
    ...
    public function show(KerusakanAlat $kerusakan)
    {
        ...
        return Inertia::render('Dashboard/Mahasiswa/Kerusakan/Show', [
