...
class AlatController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render($this->viewNamespace().'/Alat/Index', [
            'items' => $items,
            'filters' => $request->only('search', 'kategori'),
            'kategoris' => KategoriAlat::where('status', 'aktif')->orderBy('nama')->pluck('nama', 'id'),
            'base' => '/dashboard/'.str_replace('.', '/', $this->routePrefix()).'alat',
        ]);
    }
    ...
    public function create()
    {
        ...
        return Inertia::render($this->viewNamespace().'/Alat/Create', [
            'labs' => Laboratorium::whereIn('id', $this->labIds())->orderBy('nama')->get(['id', 'nama']),
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route($this->routePrefix().'alat.edit', $alat)->with('success', 'Alat berhasil ditambahkan. Silakan tambahkan galeri, dokumen, dan video jika diperlukan.');
    }
    ...
    public function show(Alat $alat)
    {
        ...
        if (! in_array($alat->laboratorium_id, $this->labIds())) {
            abort(403);
        }
        ...
        return Inertia::render($this->viewNamespace().'/Alat/Show', [
            'item' => $alat->toArray(),
    ...
    public function edit(Alat $alat)
    {
        ...
        return Inertia::render($this->viewNamespace().'/Alat/Edit', [
            'item' => $alat,
            'events' => DetailDataService::eventsForAlat($alat),
            'riwayat' => DetailDataService::riwayatForAlat($alat),
            'labs' => Laboratorium::whereIn('id', $this->labIds())->orderBy('nama')->get(['id', 'nama']),
    ...
    public function update(Request $request, Alat $alat)
    {
        ...
        return redirect()->route($this->routePrefix().'alat.index')->with('success', 'Alat berhasil diperbarui.');
    }
    ...
    private function validateAlat(Request $request, ?Alat $alat = null): array
    {
        ...
        $rules = [
            ...
            'laboratorium_id' => ['required', 'in:' . implode(',', $labIds)],
