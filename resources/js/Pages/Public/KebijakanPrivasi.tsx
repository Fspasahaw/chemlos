...
export default function KebijakanPrivasi() {
    ...
    const content = (settings?.['legal.kebijakan_privasi'] as string | undefined) || 'Kebijakan Privasi belum tersedia.';
            ...
            <section className="bg-linear-to-br from-indigo-600 to-violet-700 py-16 text-white">
                <div className="mx-auto max-w-7xl px-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-3xl font-bold md:text-4xl">Kebijakan Privasi</h1>
                    </div>
                </div>
            </section>
