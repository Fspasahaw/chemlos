...
export default function Edit() {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/dashboard/admin/program-studi/${item.id}`);
    };
        ...
        <>
            ...
            <div className="mb-6">
                ...
                <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Edit Program Studi</h1>
                    <Link href={`/dashboard/admin/program-studi/${item.id}`}>
