...
export default function Create() {
    const { labs, kategoris, base = '/dashboard/admin/alat' } = usePage().props as any;
    const { data, setData, post, processing, errors, clearErrors } = useForm({
        nama: '', kode: '', laboratorium_id: '', kategori_id: '', deskripsi: '', kondisi: 'baik',
        ...
        <>
            ...
            <form onSubmit={submit} className="space-y-4 rounded-2xl border border-slate-200/80 bg-white p-6 dark:border-slate-800/80 dark:bg-slate-900">
                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <SelectSearch label="Laboratorium *" options={labOptions} value={data.laboratorium_id} onChange={(v) => setData('laboratorium_id', v)} error={errors.laboratorium_id} />
